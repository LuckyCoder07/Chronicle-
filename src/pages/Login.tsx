    ...
    <div className="max-w-md mx-auto mt-[80px]">
      ...
      >
        <div className="text-center mb-[30px]">
          <h1 className="font-serif text-[32px] font-bold text-editorial-text mb-[10px] tracking-[-0.5px]">Welcome back</h1>
          <p className="text-[14px] text-editorial-muted font-serif italic">Sign in to your account</p>
        </div>
        ...
        <p className="mt-[30px] text-center text-[13px] text-editorial-muted border-t border-editorial-border pt-[20px]">
          Don't have an account? <Link to="/register" className="text-editorial-text font-bold uppercase tracking-[0.5px] text-[11px] ml-[8px] hover:underline">Sign up</Link>
        </p>
      </motion.div>
    </div>
  );
